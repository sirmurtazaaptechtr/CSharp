...
namespace Dec232023 {
    ...
    public partial class schoolDataSet : global::System.Data.DataSet {
        ...
        public partial class teachersDataTable : global::System.Data.TypedTableBase<teachersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public teachersRow AddteachersRow(string name, string address, int salary) {
...
namespace Dec232023.schoolDataSetTableAdapters {
    ...
    public partial class teachersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[teachers] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[teachers] ([name], [address], [salary]) VALUES (@name, @addres" +
                "s, @salary);\r\nSELECT id, name, address, salary FROM teachers WHERE (id = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[teachers] SET [name] = @name, [address] = @address, [salary] = @salary WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)));
SELECT id, name, address, salary FROM teachers WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Dec232023.Properties.Settings.Default.schoolConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, salary FROM dbo.teachers";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_address, global::System.Nullable<int> Original_salary) {
        ...
        public virtual int Insert(string name, string address, global::System.Nullable<int> salary) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string address, global::System.Nullable<int> salary, int Original_id, string Original_name, string Original_address, global::System.Nullable<int> Original_salary, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, global::System.Nullable<int> salary, int Original_id, string Original_name, string Original_address, global::System.Nullable<int> Original_salary) {
